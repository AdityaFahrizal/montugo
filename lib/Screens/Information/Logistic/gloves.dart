...
class SarungTangan extends StatefulWidget {
  const SarungTangan({super.key});

  @override
  _SarungTanganState createState() => _SarungTanganState();
}

class _SarungTanganState extends State<SarungTangan> {
  final DocumentReference sarungtanganRef =
      FirebaseFirestore.instance.collection('barang').doc('sarungtangan');
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<DocumentSnapshot>(
      stream: sarungtanganRef.snapshots(),
