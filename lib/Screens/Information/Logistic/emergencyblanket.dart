...
class EmergencyBlanket extends StatefulWidget {
  const EmergencyBlanket({super.key});

  @override
  _EmergencyBlanketState createState() => _EmergencyBlanketState();
}

class _EmergencyBlanketState extends State<EmergencyBlanket> {
  final DocumentReference selimutRef =
      FirebaseFirestore.instance.collection('barang').doc('selimut');
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<DocumentSnapshot>(
      stream: selimutRef.snapshots(),
